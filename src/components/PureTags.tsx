...
export const h2: FC<{ children?: JSX.Element; key: number }> = (props) => <h2>{props.children}</h2>;
...
// export const a: FC<{ children?: JSX.Element; anchorAttr?: React.AnchorHTMLAttributes<HTMLAnchorElement> }> = (
//   props
// ) => <a href={props.anchorAttr?.href}>{props.children}</a>;
